...
class CritterGUI():
    def __init__(self, model):
        ...
        self.tick_button = tk.Button(self.root, text = 'Tick', bg = 'light goldenrod',
                                     width = 6, command = self.tick)
        self.tick_button.grid(column = 10, row = 10)

        # Reset - stop running, display a new critter model.
        self.reset_button = tk.Button(self.root, text = 'Reset', bg = 'sky blue',
    ...
    def start(self):
        self.root.winfo_toplevel().title("Critter World")
        self.root.mainloop()
